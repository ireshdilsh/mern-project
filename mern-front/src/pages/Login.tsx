    ...
    <div className='flex justify-center items-center' id='login-page'>
      <div className='flex justify-center items-center flex-col mt-20 w-150'>
        ...
        <div className='flex flex-col mt-8 gap-3'>
          <button className='flex justify-center items-center gap-4 cursor-pointer border border-neutral-300 rounded-3xl w-100 text-neutral-700 py-2.5'><img src="https://img.icons8.com/?size=100&id=V5cGWnc9R4xj&format=png&color=000000" alt="google-logo" className='h-7' /> Sign in with Google</button>
