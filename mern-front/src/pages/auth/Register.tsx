  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50 flex items-center justify-center px-4 py-12 relative overflow-hidden'>
      ...
      <div className='absolute inset-0'>
        ...
        <div className='absolute bottom-1/4 left-1/4 w-96 h-96 bg-pink-200/50 rounded-full blur-3xl animate-pulse' style={{animationDelay: '1.5s'}}></div>
      </div>
      ...
      <div className='relative max-w-md w-full'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-slate-600'>Start preserving your memories today</p>
        </div>

        {/* Register Card */}
        <div className='glass-card p-8 rounded-3xl max-h-[85vh] overflow-y-auto'>
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div className='flex items-start pt-2'>
              <input
                ...
                onChange={handleChange}
                className='w-4 h-4 mt-1 text-purple-600 border-white/20 rounded focus:ring-purple-500 bg-white/10'
                required
              />
          ...
          <div className='grid grid-cols-2 gap-3'>
            <button className='flex items-center justify-center space-x-2 py-3 px-4 glass-card rounded-xl hover:bg-white/20 transition-all group'>
