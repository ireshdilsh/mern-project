    ...
    <div className='min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-white flex items-center justify-center px-4 py-12'>
      <div className='max-w-md w-full'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='mt-2 text-neutral-600'>Start preserving your family memories today</p>
        </div>
        ...
        <div className='bg-white rounded-2xl shadow-xl p-8'>
          <form onSubmit={handleSubmit} className='space-y-5'>
            ...
            <div className='flex items-start'>
              <input
                ...
                onChange={handleChange}
                className='w-4 h-4 mt-1 text-purple-600 border-neutral-300 rounded focus:ring-purple-500'
                required
              />
            ...
            <button
              type='submit'
              className='w-full bg-gradient-to-r from-purple-600 to-pink-500 text-white py-3 rounded-lg font-medium hover:shadow-lg transform hover:scale-[1.02] transition-all'
            >
              Create Account
            </button>
          </form>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <button className='flex items-center justify-center space-x-2 py-3 px-4 border border-neutral-300 rounded-lg hover:bg-neutral-50 transition-colors'>
