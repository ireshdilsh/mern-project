    ...
    return (
        <div className='py-20'>
            <div className='flex justify-center items-center flex-col'>
                ...
                <h1 className='text-lg font-semibold'>Welcome Back to Your Creative Space</h1>
                <p className='text-neutral-400'>Access your account and continue generating stunning AI images instantly.</p>
            </div>
