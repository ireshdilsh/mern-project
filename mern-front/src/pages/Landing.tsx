...
export default function Landing() {
  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      {/* Sign In Modal */}
      {showSignInModal && (
        <div className='fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4' onClick={() => setShowSignInModal(false)}>
          <div className='bg-white rounded-2xl shadow-2xl w-full max-w-md p-12 relative' onClick={(e) => e.stopPropagation()}>
            ...
            <button onClick={handleGoogleAuth} className='w-full flex items-center justify-center gap-3 px-6 py-2 bg-white border-2 border-gray-300 rounded-xl hover:bg-gray-50 hover:border-blue-600 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-sm'>
