    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center gap-8 mt-32'>
                ...
                <div className='flex justify-center items-center flex-col gap-8 mt-10 py-15 w-full '>
                    ...
                    <p className='text-center text-neutral-600 mb-5'>Our AI platform empowers millions of creators worldwide.
                        Generate high-quality images instantly, explore thousands <br/> of unique styles, and bring your imagination to life—effortlessly and reliably.</p>
                </div>
            </div>
        </div>
    )
