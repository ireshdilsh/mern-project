        ...
        <div id='main-page' className='min-h-screen bg-gray-50'>
            ...
            <section id='features' className='bg-white flex content-center items-center flex-col mt-6 pt-12 pb-22 pl-36 pr-36'>
                ...
                <div className='grid grid-cols-2 gap-8 mt-12'>
                    ...
                    <div id='right-side' className='flex items-center justify-center relative'>
                        <div className='relative w-full max-w-lg'>
                            ...
                            <div className='relative bg-white rounded-2xl shadow-2xl p-4'>
                                ...
                                <div className='absolute -bottom-6 -left-4 bg-white rounded-lg shadow-lg p-3 border border-gray-100'>
                                    <div className='flex items-center gap-2'>
                                ...
                                <div className='absolute top-1/2 -left-6 transform -translate-y-1/2 bg-white rounded-lg shadow-lg p-3 border border-gray-100'>
                                    <div className='flex items-center gap-2'>
