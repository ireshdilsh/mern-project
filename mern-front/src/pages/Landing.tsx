        ...
        <div className='flex flex-col justify-center items-center h-screen bg-gray-100 gap-24'>
            <div className=''>
                ...
                <div className='mt-5 flex gap-2'>
                    <button className='bg-indigo-500 text-white px-4 py-2 rounded cursor-pointer'>Get Started</button>
                    <button className='bg-gray-300 text-gray-700 px-4 py-2 rounded cursor-pointer'>Get Started</button>
                </div>
            </div>
