    ...
    <div id='landing-page' className='flex justify-center items-center flex-col '>
      <nav className='flex justify-between items-center w-full mt-4'>
        ...
        <div className='flex justify-center items-center gap-4 mr-50'>
          <a className='font-normal z-10' href="#">Home</a>
      ...
      <section className='flex justify-center items-center flex-col mt-33 px-50 relative'>
        ...
        <div className='flex justify-center items-center gap-8 mt-8'>
          <button className='bg-black text-xl text-white border-none z-10 rounded-4xl cursor-pointer px-10 py-3 font-medium w-52'>Join Now</button>
        ...
        <div className='h-100 w-100 rounded-full absolute top-0 left-0 right-0 bottom-0 m-auto' id='gradient-border'>
          <div className='h-15 w-15 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 absolute top-25 left-30 blur-3xl'></div>
          <div className='h-15 w-15 rounded-full bg-gradient-to-r from-purple-600 to-red-600 absolute bottom-25 right-30 blur-3xl'></div>
        </div>
      </section>
