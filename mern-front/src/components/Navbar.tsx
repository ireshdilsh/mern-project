        ...
        <div>
            ...
            {signInModal && (
                <div className='flex justify-center items-center flex-col w-full h-full absolute left-0 top-0' id='modal-overlay'>
                    <div className='bg-white w-4xl rounded-md flex justify-between items-center'>
                        <div className='flex flex-col p-10 w-115'>
                            <img src={logo} className='w-30 mb-4' alt="" />
                            <h1 className='text-2xl font-semibold text-[#333] tracking-tighter'>Sign In to Continue</h1>
                            <p className='mt-3 text-neutral-500 w-96 text-justify text-sm'>Manage your projects, generate thumbnails, and keep your progress synced across devices.</p>
                        ...
                        <div className='h-full'>
                            <img id='signin-img' src={login} alt="" className='overflow-hidden h-full'/>
                        </div>
                    </div>
                </div>
            )}
