    ...
    <div className='w-full' id='hero-bg'>
      ...
      <div className='flex justify-center items-center flex-col pb-35 mt-29'>
        ...
        <div className='flex justify-center items-center gap-5 mt-10'>
          <button className='bg-black text-white px-5 py-3 font-semibold rounded-lg outline-none cursor-pointer hover:opacity-80'>Create Free Account</button>
      ...
      {openSignInModal && (
        <div className='w-full h-full absolute top-0 left-0 flex justify-center items-center' id='modal-overlay'>
            <div className='bg-white py-15 px-15 w-120 flex justify-center items-center flex-col rounded-lg'>
              ...
              <button className='cursor-pointer mt-5 border border-neutral-400 rounded-sm w-full py-2 font-bold text-neutral-700 flex justify-center items-center gap-5'><img className='h-6' src="https://img.icons8.com/?size=100&id=17949&format=png&color=000000" alt="" />Continue with google</button>
